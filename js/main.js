...
const story = {
  ...
  brakeAlarm:
    "You smash your alarm in defiance and now your hand is bleeding furiously.",

  tendWound:
    "You did not pay attention in first aid class. You die from blood loss.",

  lickWound:
    "Your blood is delicious and realize the path you want to follow. You break from the chains of reality and set off to be like your hero Edward Cullen. However, you did not make it to work.",

  shower:
    "While singing in the shower you attempt a power glide and break your neck in the process.",
  ...
  shortAndT:
    "You take no time getting ready and head out 15 minutes early. Awesome! Although cloudy, the weather is nice and cool. You want to take advantage of this and decide not to take the bus today.",
  ...
  talkDown:
    "Due to his anger issues, your uber driver has a rage outburst and slams on the gas. The car accelerates rapidly without giving you time to react. At 140mph the car hits an oncoming car head on. You die on impact.",

  stayQuiet:
    "Your silence makes the driver talk even more, which distracts him from the road ahead. An 18-wheeler that happened to take a detour that day, swerves into your lane to avoid a pedestrian on a scooter that slipped on to  the road. Your driver, being distracted, does not notice and rams into the back of the trailer. You both die on impact.",

  startConvo:
    'In mid conversation, the gentlemen notices the bus approaching. "We better get on the bus" he says. You have a pleasant ride so far, but just one stop before yours an elderly lady gets in. All the seats are taken.',
  ...
  bikeRide:
    "You ride like a pro, almost gliding through the air. 15 minutes into your commute the heavens open up and rain starts pouring on you! You think about slowing down to be safe, but you can also go hard and get to work faster.",
  ...
  scooter:
    "You take a shot at those scooters that have overtaken the city. As soon as you ride of your complex you panic and ride into oncoming traffic. An 18-wheeler that just so happen to have taken a detour that day, is not able to stop on time. He hits you killing you on the spot.",
...
const storyChoice = {
  ...
  wakeup: {
    "button-one": "take cold shower",
    "button-two": "skip shower and get breakfast"
  },
  ...
  getReady: {
    "button-one": "shorts and T-shirt",
    "button-two": "slacks and nice shirt"
  },
  ...
  uber: {
    "button-one": "talk down on his team",
    "button-two": "be respectfull, stay quiet"
  },

  shortAndT: { "button-one": "ride bike", "button-two": "ride scooter" },

  bikeRide: {
    "button-one": "be safe, slow down",
    "button-two": "go hard, power through it"
  },

  startConvo: {
    "button-one": "offer your seat",
    "button-two": "do nothing, you will get off soon anyway"
  },

  offerSeat: {
    "button-one": "take elevator",
    "button-two": "get a morning workout! take stairs."
  },

  elevator: {
    "button-one": "offer to hold ladder",
    "button-two": `ignore and walk into your office`
  },
  ...
  switch (state) {
    ...
    case story.shower:
      ...
      headerEl.style.textShadow =
        "1px 1px #a01e14, 3px 3px #a01e14, 5px 5px #a01e14";
      button1.style.textShadow =
        "1px 1px #a01e14, 3px 3px #a01e14, 5px 5px #a01e14";
      button2.style.textShadow =
        "1px 1px #a01e14, 3px 3px #a01e14, 5px 5px #a01e14";
      break;
